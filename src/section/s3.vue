  ...
  <div class="s3">
    <div class="s3_1">
      <div class="text">
        ...
        <h3 data-aos="fade-up" data-aos-delay="200">從植物園到青年公園，住進台北最Chill的一公里</h3>
      ...
      <div class="pic" data-aos="fade-left">
        ...
        <div class="pic_content">
          ...
          <p class="directions font-['Noto_Sans_TC',serif]">植物園</p>
        </div>
      </div>
    </div>
    <div class="s3_2">
      <div class="text">
        ...
        <h3 data-aos="fade-up" data-aos-delay="200">被17萬坪綠地環繞的日常，才叫台北的高級自由</h3>
        <p data-aos="fade-up" data-aos-delay="400">
          青年公園24.6公頃 ×
      ...
      <div class="pic" data-aos="fade-right">
        ...
        <p class="directions font-['Noto_Sans_TC',serif]">青年公園</p>
    ...
    <div class="s3_3">
      <div class="text">
        ...
        <h3 data-aos="fade-up" data-aos-delay="200">古亭＋植物園雙站串聯，新蘆＋新店＋萬大線三軌通勤日常</h3>
        <p data-aos="fade-up" data-aos-delay="400">
...
.s3 {
  ...
  .s3_1 {
    ...
    .text {
      ...
      padding: sizem(50) sizem(58) sizem(20) sizem(50);

      @media screen and (min-width: 768px) {
        width: 54%;
        margin-top: size(50);

        border-left: solid size(215) #8fb538;
    ...
    .pic {
      position: relative;
      border-right: solid sizem(10) #8fb538;

      @media screen and (min-width: 768px) {
        width: 46%;
        border-right: solid size(15) #8fb538;
        margin-bottom: size(135);
        order: 2;
      }
  ...
  .s3_2 {
    ...
    .text {
      color: #fff;
      background: #8fb538;
      padding: sizem(50) sizem(64) sizem(50 + 134) sizem(50);
      margin: 0 0 sizem(-134) 0;

      @media screen and (min-width: 768px) {
        order: 2;
        width: calc(52% + size(215));
        margin: size(160) 0 0 size(-215);
        padding: size(160) size(260) size(101) size(430);
      }
    }
  }
